...
Options:
  ...
  --method <m>      direct | eco  (default: direct). Both methods are gasless —
                    the deposit runs through your smart-contract wallet and
                    Circle sponsors the gas either way; eco is just the faster
                    route (sources from Base — Circle CLI ≥1.0.0's eco coverage)
