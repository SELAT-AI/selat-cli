 ...
 * --json. --verbose is handled here: it replays the ranker's stderr (catalog-loader
 * warnings), which is otherwise suppressed unless the ranker fails. No payment path
 * exists in this command — rank.mjs without --pick never settles.
 */
