...
import { ensureSelatPayHistoryDir, resolveSelatPay, selatPayMissingError, selatPaySpawn } from "./selat-pay.mjs";
...
export async function invokeSkill(name, cliParams = {}, { overrides = {}, onStep, continueOnError = true, capture = false } = {}) {
  ...
  if (selatPay.source === null) throw selatPayMissingError();
