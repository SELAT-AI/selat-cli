...
export function compileStep(manifest, step, params, overrides = {}, defaultChain = null) {
  ...
  // ceiling (default $1). A TTY raise / --allow-high-max-amount may lift it
  // to $5. A cap that comes from the untrusted manifest/step stays bounded
  // by the manifest ceiling.
  let maxAmount;
