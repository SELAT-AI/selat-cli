...
// now clamped to the same hard CLI ceiling; isTTY cannot raise it.
 ...
 * authorized against the hard CLI ceiling (default $1.10; isTTY / allowHigh
 * cannot raise it). Anything derived from catalog/probe data is clamped to
