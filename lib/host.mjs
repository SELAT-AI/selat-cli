...
/**
 * Print the sandbox allowlist hint to stderr, but only when egress really is
 * blocked. Every catalog-failure path pairs the probe with the same dim hint;
 * this keeps that pairing in one place.
 */
export async function warnIfEgressBlocked() {
